...
const questions = [
  ...
  // 6 questions 
  { question: "Quel est le pronom personnel sujet pour 'moi' ?", answers: ["je", "tu", "il", "elle"], correct: 0 },
  { question: "Quel est le pronom personnel sujet pour 'toi' ?", answers: ["il", "je", "tu", "vous"], correct: 2 },
  { question: "Quel est le pronom personnel sujet pour 'lui' ?", answers: ["elle", "ils", "il", "tu"], correct: 2 },
  { question: "Quel est le pronom personnel sujet pour 'elle' ?", answers: ["je", "elle", "nous", "tu"], correct: 1 },
  { question: "Quel est le pronom personnel sujet pour 'nous' ?", answers: ["vous", "ils", "nous", "elles"], correct: 2 },
  { question: "Quel est le pronom personnel sujet pour 'vous' ?", answers: ["tu", "vous", "nous", "ils"], correct: 1 },
  { question: "Quel est le pronom personnel sujet pour 'eux' ?", answers: ["elles", "il", "nous", "ils"], correct: 3 },
  { question: "Quel est le pronom personnel sujet pour 'elles' ?", answers: ["elles", "nous", "vous", "il"], correct: 0 },
  { question: "Quel est le pronom personnel sujet pour 'Jean et moi' ?", answers: ["vous", "nous", "ils", "elle"], correct: 1 },
  { question: "Quel est le pronom personnel sujet pour 'Marie et toi' ?", answers: ["nous", "ils", "vous", "tu"], correct: 2 },
  { question: "Quel est le pronom personnel sujet pour 'Paul' ?", answers: ["il", "elle", "tu", "je"], correct: 0 },
  { question: "Quel est le pronom personnel sujet pour 'Sophie' ?", answers: ["il", "tu", "elle", "vous"], correct: 2 },
  { question: "Quel est le pronom personnel sujet pour 'les enfants' ?", answers: ["il", "elles", "vous", "ils"], correct: 3 },
  { question: "Quel est le pronom personnel sujet pour 'ma sœur et moi' ?", answers: ["nous", "vous", "ils", "elles"], correct: 0 },
  { question: "Quel est le pronom personnel sujet pour 'toi et lui' ?", answers: ["ils", "vous", "nous", "elle"], correct: 1 },
  { question: "Quel est le pronom personnel sujet pour 'la voiture' ?", answers: ["elle", "il", "nous", "vous"], correct: 0 },
  { question: "Quel est le pronom personnel sujet pour 'le livre' ?", answers: ["elle", "tu", "il", "nous"], correct: 2 },
  { question: "Quel est le pronom personnel sujet pour 'mes parents' ?", answers: ["ils", "elles", "nous", "vous"], correct: 0 },
  { question: "Quel est le pronom personnel sujet pour 'toi et moi' ?", answers: ["nous", "vous", "ils", "elle"], correct: 0 },
  { question: "Quel est le pronom personnel sujet pour 'les filles' ?", answers: ["ils", "elles", "vous", "nous"], correct: 1 }
];
